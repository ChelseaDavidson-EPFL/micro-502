...
ALIGN_DIST = 0.45 
PRE_WAYPOINT_REACHED_EPS = 0.95
POST_WAYPOINT_REACHED_EPS = 0.45
GATE_REACHED_EPS = 0.35
WAYPOINT_YAW_REACHED_EPS = 0.35
...
class MyAssignment:
    ...
    def get_execute_trajectory_command(self, sensor_data):
        ...
        post_gate = np.array([
            center[0] + np.cos(yaw) * ALIGN_DIST*0.5,
            center[1] + np.sin(yaw) * ALIGN_DIST*0.5,
            center[2]
        ])
